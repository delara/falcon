package com.edgestream.worker.metrics.icmp4j.logger;

import java.util.Map;
import java.util.HashMap;

import com.edgestream.worker.metrics.icmp4j.logger.constants.LogLevel;
import com.edgestream.worker.metrics.icmp4j.logger.constants.LogLevelName;
