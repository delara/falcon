...
import com.edgestream.worker.metrics.icmp4j.platform.NativeBridge;
import com.edgestream.worker.metrics.icmp4j.util.PlatformUtil;
import com.edgestream.worker.metrics.icmp4j.constants.OsFamilyCode;
    ...
    synchronized (Icmp4jUtil.class) {
      ...
      try {
        ...
        final String nativeBridgeClassName =
          osFamilyCode == OsFamilyCode.ANDROID ? "com.edgestream.worker.metrics.icmp4j.platform.android.AndroidNativeBridge" :
          osFamilyCode == OsFamilyCode.LINUX ?   "com.edgestream.worker.metrics.icmp4j.platform.unix.UnixNativeBridge" :
          osFamilyCode == OsFamilyCode.MAC ?     "com.edgestream.worker.metrics.icmp4j.platform.unix.UnixNativeBridge" :
          osFamilyCode == OsFamilyCode.WINDOWS ? "com.edgestream.worker.metrics.icmp4j.platform.windows.WindowsNativeBridge" :
                                                 "com.edgestream.worker.metrics.icmp4j.platform.java.JavaNativeBridge";
