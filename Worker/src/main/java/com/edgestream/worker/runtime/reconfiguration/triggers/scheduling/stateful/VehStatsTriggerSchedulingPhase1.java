...
public class VehStatsTriggerSchedulingPhase1 extends ReconfigurationTrigger {

    public VehStatsTriggerSchedulingPhase1(String triggerID, String topologyID) {
...
//        }
    ...
    public ArrayList<ExecutionPlan> getExecutionPlans(DataCenterManager dataCenterManager) {
        ...
        String targetTaskManagerDeployment_W003 = "W002"; //create a replica at W003;
...
//        keyList.add(sensorID1Key);
        ...
        routingKey_W003.activateSynchronization(getTopologyID(),"V","W002", routingKey_W003);
